...
import { checkId, checkIdExisted, checkStudentExisted, checkBirthday, checkEmpty, checkNameLength } from '../handlers/validate';
...
const CreatePanel = ({ open, columns, tableData, onClose, onSubmit }) => {
  ...
  const handleSubmit = () => {
    ...
    if (checkEmpty(values.ten) || checkEmpty(values.msv) || checkEmpty(values.nsinh) || checkEmpty(values.que)) {
    ...
    else if (checkNameLength(values.ten) == false) {
      setErrorlogin(<div><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#D9212C" viewBox="0 0 16 16"><path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z"></path><path d="M7.002 11a1 1 0 1 1 2 0 1 1 0 0 1-2 0zM7.1 4.995a.905.905 0 1 1 1.8 0l-.35 3.507a.552.552 0 0 1-1.1 0L7.1 4.995z"></path></svg>Quá 100 ký tự!</div>);
      setLogboxStyle({ backgroundColor: '#ffc0c7', margin: "20px auto", borderRadius: '5px', color: '#282a35', padding: '10px' });
    }
    else if (checkNameLength(values.que) == false) {
      setErrorlogin(<div><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#D9212C" viewBox="0 0 16 16"><path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z"></path><path d="M7.002 11a1 1 0 1 1 2 0 1 1 0 0 1-2 0zM7.1 4.995a.905.905 0 1 1 1.8 0l-.35 3.507a.552.552 0 0 1-1.1 0L7.1 4.995z"></path></svg>Quá 100 ký tự!</div>);
      setLogboxStyle({ backgroundColor: '#ffc0c7', margin: "20px auto", borderRadius: '5px', color: '#282a35', padding: '10px' });
    }
      ...
      setLogboxStyle({ backgroundColor: '#ffc0c7', margin: "20px auto", borderRadius: '5px', color: '#282a35', padding: '10px' });
    } else if (checkId(values.msv) == false) {
